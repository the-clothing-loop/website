  ...
  return (
    <IonPage>
      <div className="tw-absolute tw-inset-0">
        <div className="tw-relative tw-z-10 tw-flex tw-h-full tw-flex-col tw-justify-center tw-items-center tw-text-center">
        ...
        <div className="tw-absolute tw-z-0 tw-inset-0 tw-bg-paused tw-opacity-20"></div>
      </div>
    </IonPage>
  );
}
