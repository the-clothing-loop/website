...
export const SearchBar: React.FC<IProps> = ({
  ...
  return (
    <div className="tw-container tw-mx-auto">
      ...
      >
        <div className="tw-flex tw-w-full lg:tw-w-auto lg:tw-flex-grow tw-h-12 lg:tw-pr-4">
          <TextField
            id="outlined-basic"
            placeholder={t("searchLocation")}
            variant="outlined"
            classes={{
              root: classes.input + " tw-w-full tw-min-w-0 tw-min-h-auto",
            }}
            value={searchTerm}
